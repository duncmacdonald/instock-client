          ...
          <div className="inventoryDetailsSection">
            <form className="invDetailsForm">
              ...
              <select
                ...
                onChange={(event) => {
                  this.setState({ form: { category: event.target.value } });
                }}
              >
            ...
            <form className="availabilityForm">
              ...
              <span>
                <input
                  ...
                  value="In Stock"
                  onChange={(event) =>
                    this.setState({ form: { status: "In Stock" } })
                  }
                />
                ...
                <input
                  ...
                  value="Out of Stock"
                  onChange={(event) =>
                    this.setState({ form: { status: "Out of Stock" } })
                  }
                />
              ...
              <select
                ...
                onChange={(event) => {
                  this.setState({ form: { warehouse: event.target.value } });
                }}
              >
